...
defn_path =  "{}.atlas11.lps.umontreal.ca/GttNN_2.definition.txt".format(ID)
model_path =  "{}.atlas11.lps.umontreal.ca/GttNN_2.keras_model.h5".format(ID)
norm_path =  "{}.atlas11.lps.umontreal.ca/GttNN_2.normalization.txt".format(ID)
...
#model = Model.TrainedModel.from_files(defn_path, model_path, norm_path)
